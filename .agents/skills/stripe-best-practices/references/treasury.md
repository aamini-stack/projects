...
money movement), use the
[v2 Financial Accounts API](https://docs.stripe.com/api/v2/core/vault/financial-accounts.md)
(`POST /v2/core/vault/financial_accounts`). This is required for new
integrations.

For Treasury for platforms concepts and guides, see the
...
(`POST /v1/treasury/financial_accounts`) for new integrations. Existing v1
