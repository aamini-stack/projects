...
> I've written/updated `UBIQUITOUS_LANGUAGE.md`. From this point forward I will
> use these terms consistently. If I drift from this language or you notice a
> term that should be added, let me know.
