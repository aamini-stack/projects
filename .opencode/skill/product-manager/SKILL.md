...
description: Organizing features and complex work into manageable/logical tasks
...
<overview>
<instruction>
Provide brief context about the project and key technologies being used.
</instruction>
...
Tasks: - Implement schema validator (uses: base types, error handling) - Build data ingestion pipeline (uses: validator, config)
