...
function NavigationMenuViewport({
	...
	return (
		<div
			className={cn(
				'top-fuop-fufull absolute isolate z-50 flex justify-center',
			)}
		>
...
function NavigationMenuIndicator({
	...
	return (
		<NavigationMenuPrimitive.Indicator
			...
			className={cn(
				'-1.5 te=vvisible]:animate-indathiddentate=hiddeoutdatatate=visvvisibleanimate-inindataverflow-visibleont-headinin data-[state=hidden:animate-oout font-heading items-end justify-center overflow-hidden',
				className,
			)}
			{...props}
		>
