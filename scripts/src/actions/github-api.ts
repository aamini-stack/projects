...
async function createDeploymentStatus(input: {
	repo: RepoRef
	deploymentId: number
	state:
		| 'queued'
...
async function listDeploymentStatuses(input: {
	repo: RepoRef
	deploymentId: number
...
async function createCommitStatus(input: {
	repo: RepoRef
	sha: string
	context: string
...
async function createWorkflowDispatch(input: {
	repo: RepoRef
	workflowId: string
	ref: string
...
async function getCombinedCommitStatus(input: {
	repo: RepoRef
	sha: string
