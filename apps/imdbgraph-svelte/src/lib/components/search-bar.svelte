...
<div
	class="bg-background text-popover-foreground relative flex h-full w-full flex-col text-sm"
>
	<!-- Hidden label for accessibility -->
	<label for="search-bar-input" class="sr-only"> Search for TV shows </label>
	...
	{#if error}
		<div aria-live="polite" class="text-destructive px-2 py-1.5 text-center">
