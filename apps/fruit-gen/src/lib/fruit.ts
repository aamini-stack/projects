...
export const fruits: Fruit[] = [
	...
	},
	{
		...
		color: 'Yellow',
		taste: 'Sour & Tangy',
		benefits: ['High in Vitamin C', 'Detoxifying', 'Aids digestion', 'Immune support'],
		description: 'Zesty and refreshing, lemons are great for flavoring and health.',
		nutritionFacts: {
			calories: 29,
			vitaminC: '88% DV',
			fiber: '2.8g',
	...
	},
	{
		...
		color: 'Green',
		taste: 'Sour & Aromatic',
		benefits: ['Rich in Vitamin C', 'Antioxidants', 'Skin health', 'Aids digestion'],
	...
	},
	{
		...
		description: 'A versatile tropical fruit, great for hydration and healthy fats.',
		nutritionFacts: {
			calories: 354,
			vitaminC: '4% DV',
			fiber: '9g',
	...
	},
	{
		...
		description: 'Sweet and unique, figs are a delightful treat with many health benefits.',
		nutritionFacts: {
			calories: 74,
			vitaminC: '2% DV',
			fiber: '2.9g',
	...
	},
	{
		...
		benefits: ['Natural sweetener', 'High in fiber', 'Potassium', 'Energy boost'],
		description: 'Dates are a naturally sweet fruit, perfect for energy and a healthy snack.',
		nutritionFacts: {
			calories: 282,
			vitaminC: '0% DV',
			fiber: '6.7g',
