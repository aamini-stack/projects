...
/**
 * Stream files directly from IMDB into temp tables using efficient bulk operations.
 * Once all data is loaded into temp tables, update all the real tables with
 * data from the temp tables.
 *
 * This approach streams data directly into the database without writing to disk,
 * which is important for serverless environments with limited disk space.
 */
