...
function Home() {
	...
	return (
		<div className="flex flex-1 flex-col items-center gap-6 pt-8 md:gap-9 md:pt-20">
			<h1 className="inline bg-gradient-to-r from-purple-300 via-purple-100 to-purple-300 bg-clip-text px-8 text-center text-4xl font-semibold tracking-tight text-balance text-transparent md:text-5xl lg:text-6xl">
				IMDb Graph
			</h1>
