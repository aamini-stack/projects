...
const buttonVariants = cva(
	cn(
		'box-shadow inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-base border-2 border-border bg-main font-base text-main-foreground text-sm',
...
export { Button, ScrollButton, buttonVariants, LinkButton }
