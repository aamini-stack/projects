...
export function VideoPlayer() {
	...
	return (
		<div className="flex h-full w-full">
			...
			{/* Chat Window */}
			<div className="flex w-[340px] flex-col border-[#2f2f32] border-l text-[#dedee3] text-[13px] leading-5">
				{/* Title */}
				<div className="flex h-[50px] items-center justify-center border-white/[.1] border-b bg-[#1f1f23]">
