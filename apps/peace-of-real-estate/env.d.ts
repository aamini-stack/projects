...
declare module 'varlock/env' {
  ...
  export interface PublicTypedEnvSchema extends Readonly<Pick<CoercedEnvSchema, 'APP_ENV' | 'VITE_PUBLIC_POSTHOG_KEY' | 'BETTER_AUTH_URL' | 'AWS_REGION' | 'AVATAR_BUCKET' | 'AVATAR_BASE_URL'>> {}
}
