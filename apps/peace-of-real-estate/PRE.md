...
Download logo files for various applications. SVG recommended for web and print.

| Asset            | Format | Usage                 |
| ---------------- | ------ | --------------------- |
| Full Logo Color  | SVG    | For light backgrounds |
| Full Logo Light  | SVG    | For dark backgrounds  |
| Full Logo Dark   | SVG    | Monochrome            |
| Logomark Color   | SVG    | Logomark only         |
| Logomark Light   | SVG    | For dark backgrounds  |
| Logomark Dark    | SVG    | Monochrome            |

SVG files are resolution-independent and work for both web and print.
